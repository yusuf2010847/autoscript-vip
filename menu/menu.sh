...
Exp2=$(curl -sS https://raw.githubusercontent.com/yusuf2010847/permission/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
function check_and_update() {
    ...
    if [ "$latest_commit" != "$last_commit" ]; then
        ...
        if [[ "$update_choice" == "Y" || "$update_choice" == "y" ]]; then
            ...
            wget -q https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/m-update.sh -O m-update.sh
            chmod +x m-update.sh
            ./m-update.sh
...
cd
rm -rf *
wget https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/m-update.sh
clear
