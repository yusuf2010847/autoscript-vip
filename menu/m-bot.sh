...
cd /usr/bin/
clear
wget https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/bot/bot.zip
...
mkdir -p /usr/bin/kyt/
cd /usr/bin/kyt/
wget https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/bot/kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/yusuf2010847/autoscript-vip/main/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
